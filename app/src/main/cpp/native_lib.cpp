...
Java_io_github_mixedvictor_canelaemu_cassia_CassiaManager_startServer(
        JNIEnv *env,
        jobject /* this */,
...
Java_io_github_mixedvictor_canelaemu_cassia_CassiaManager_stopServer(
        JNIEnv *env,
        jobject /* this */) {
    std::scoped_lock lock{stateMutex};
    wineCtx.reset();
...
extern "C" JNIEXPORT void JNICALL
Java_io_github_mixedvictor_canelaemu_cassia_CassiaManager_setSurface(
        JNIEnv *env,
        jobject /* this */,
        jobject surface) {
    std::scoped_lock lock{stateMutex};
